        ...
        <div>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            <p className='text-2xl font-semibold'>
              {listing.name} - ${' '}
              {listing.offer
                ? listing.discountPrice.toLocaleString('en-EU')
                : listing.regularPrice.toLocaleString('en-EU')}
            ...
            <div className='flex gap-4'>
              <p className='bg-gray-700 w-full max-w-[200px] text-white text-center p-1 rounded-md'>

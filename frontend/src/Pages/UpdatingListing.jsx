...
//  Adding Handler Submit to submit the form data to the database of MongoDB and Firebase Storage
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-2xl font-medium text-center mt-3'><span className='text-slate-500 font-bold'>{currentUser.username}, </span> here is a place to update your data</h1>
        <form onSubmit={handlerSubmitForm} className='flex  flex-col sm:flex-row gap-4 mt-6'>
            ...
            <button  className='p-3 bg-cyan-900 text-white rounded-lg uppercase hover:bg-green-700'>{loading ? 'Updating listing...' : 'Update'}</button>
